...
if (class_exists(Model::class)) {
    class ErrorLogBase extends Model
    {
    }
} else {
    class ErrorLogBase
...
class ErrorLog extends ErrorLogBase
{
    ...
    {
        $this->context = $context ? json_encode($context, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) : null;
        return $this;
    }

    public function setContextJson(?string $json): static
    {
        $this->context = $json;
        return $this;
    }
