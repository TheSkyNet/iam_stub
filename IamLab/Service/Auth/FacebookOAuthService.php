...
{
    private const string AUTHORIZATION_URL = 'https://www.facebook.com/v18.0/dialog/oauth';

    private const string TOKEN_URL = 'https://graph.facebook.com/v18.0/oauth/access_token';

    private const string USER_INFO_URL = 'https://graph.facebook.com/v18.0/me';
    ...
    public function getAccessToken(string $code, ?string $state = null): array
    {
        ...
        try {
            ...
            throw new Exception('Facebook OAuth token exchange failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
    ...
    public function getUserInfo(string $accessToken): array
    {
        ...
        try {
            ...
            throw new Exception('Facebook OAuth user info request failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
    ...
    public function getLongLivedToken(string $shortLivedToken): array
    {
        ...
        try {
            ...
            throw new Exception('Facebook OAuth long-lived token exchange failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
}
