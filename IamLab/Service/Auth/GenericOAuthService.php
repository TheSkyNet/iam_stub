...
class GenericOAuthService extends OAuthService
{
    ...
    public function getAccessToken(string $code, ?string $state = null): array
    {
        ...
        try {
            ...
            throw new Exception('Generic OAuth token exchange failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
    ...
    public function getUserInfo(string $accessToken): array
    {
        ...
        try {
            ...
            throw new Exception('Generic OAuth user info request failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
    ...
    private function normalizeUserData(array $userInfo): array
    {
        ...
        if (empty($normalized['name']) && (isset($normalized['first_name']) && ($normalized['first_name'] !== '' && $normalized['first_name'] !== '0') || isset($normalized['last_name']) && ($normalized['last_name'] !== '' && $normalized['last_name'] !== '0'))) {
