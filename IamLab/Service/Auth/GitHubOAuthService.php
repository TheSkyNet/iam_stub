...
{
    private const string AUTHORIZATION_URL = 'https://github.com/login/oauth/authorize';

    private const string TOKEN_URL = 'https://github.com/login/oauth/access_token';

    private const string USER_INFO_URL = 'https://api.github.com/user';

    private const string USER_EMAILS_URL = 'https://api.github.com/user/emails';
    ...
    public function getAccessToken(string $code, ?string $state = null): array
    {
        ...
        try {
            ...
            throw new Exception('GitHub OAuth token exchange failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
    ...
    public function getUserInfo(string $accessToken): array
    {
        ...
        try {
            ...
            throw new Exception('GitHub OAuth user info request failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
    ...
    private function getUserPrimaryEmail(string $accessToken): string
    {
        ...
        try {
            ...
            throw new Exception('GitHub OAuth email request failed: ' . $exception->getMessage(), $exception->getCode(), $exception);
        }
    }
}
