                ...
                m("table.table", [
                    ...
                    m("tbody", [
                        m("tr", [
                            ...
                            m("td.text-right", [
                                m(m.route.Link, { href: "/admin/users/edit/1", class: "btn btn-sm btn-ghost" }, m(Icon, { name: "fa-solid fa-user-pen" })),
                        ...
                        m("tr", [
                            ...
                            m("td.text-right", [
                                m(m.route.Link, { href: "/admin/users/edit/2", class: "btn btn-sm btn-ghost" }, m(Icon, { name: "fa-solid fa-user-pen" })),
                                m("button.btn.btn-sm.btn-ghost.text-error", m(Icon, { name: "fa-solid fa-trash" }))
                            ])
                        ])
                    ])
